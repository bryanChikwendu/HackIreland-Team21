...
import { Camera, Map, AlertTriangle, Users, Settings, Shield, LogOut, X, Plus, Activity, Headphones } from "lucide-react";
            ...
            <ul className="space-y-1">
              ...
              <li>
                <Button
                  variant="ghost"
                  className={`w-full justify-start ${
                    pathname === "/listeners" ? "text-blue-400 font-semibold" : "text-slate-400"
                  }`}
                  asChild
                >
                  <Link href="/listeners">
